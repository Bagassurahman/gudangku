    ...
    <div id="main-wrapper">
        <div class="pageheader pd-t-25 pd-b-35">
            <div class="pd-t-a5 pd-b-5">
                <h1 class="pd-0 mg-0 tx-20 text-overflow">Laporan Setoran</h1>
            </div>
        ...
        <div class="row row-xs clearfix">
            ...
            <div class="col-md-12 col-lg-12">
                <form action="{{ route('finance.laporan-setoran.index') }}" method="GET">
                            ...
                            <tbody>
                                ...
                                @foreach ($deposits as $deposit)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('finance.laporan-setoran.show', $deposit->deposit_date) }}"
