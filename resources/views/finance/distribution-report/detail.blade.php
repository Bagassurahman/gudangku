...
@section('title', 'Laporan Distribusi ' . $date)
@section('style')
    ...
    <div id="main-wrapper">
        <div class="pageheader pd-t-25 pd-b-35">
            <div class="pd-t-5 pd-b-5">
                <h1 class="pd-0 mg-0 tx-20 text-overflow"> Detail Laporan Distribusi {{ $warehouse->warehouse_name }}
                    <br>
                    Tanggal:
                    {{ $date }}
                </h1>
                ...
                <div class="card mg-b-20">
                    <div class="card-header">
                        <h4 class="card-header-title">
                            Detail Laporan Distribusi {{ $date }}
                        </h4>
                            ...
                            <tbody>
                                ...
                                @foreach ($distributionDetails as $key => $distribution)
                                    <tr data-entry-id="{{ $distribution->id }}">
                                        ...
                                        <td>
                                            <a href="{{ route('finance.distribution.detailBahan', ['date' => $date, 'outletId' => $distribution->outlet_id]) }}"
