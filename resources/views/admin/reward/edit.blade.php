    ...
    <div id="main-wrapper">
        <div class="pageheader pd-t-25 pd-b-35">
            <div class="pd-t-5 pd-b-5">
                <h1 class="pd-0 mg-0 tx-20 text-overflow">Edit Data Reward</h1>
            </div>
                ...
                <div class="card mg-b-20">
                    ...
                    <div class="card-body collapse show" id="collapse1">
                        <form class="form-layout form-layout-1" method="POST"
                            action="{{ route('admin.reward.update', $reward->id) }}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="form-group mg-b-10-force">
                                ...
                                <input
                                    class="form-control @error('name')
                                            is-invalid
                                        @enderror"
                                    type="text" name="name" value="{{ $reward->name }}">
                                @error('name')
                            ...
                            <div class="form-group mg-b-10-force">
                                ...
                                <input
                                    class="form-control @error('point')
                                            is-invalid
                                        @enderror"
                                    type="number" name="point" value="{{ $reward->point }}">
                                @error('point')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-group mg-b-10-force">
                                <img src="{{ asset($reward->image) }}" alt="" style="width: 100px; height:100px;">
                            ...
                            <div class="form-group mg-b-10-force">
                                ...
                                <textarea
                                    class="form-control @error('description')
                                            is-invalid
                                        @enderror"
                                    type="text" name="description">{{ $reward->description }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-group mg-b-10-force">
                                ...
                                <input
                                    class="form-control @error('stock')
                                            is-invalid
                                        @enderror"
                                    type="number" name="stock" value="{{ $reward->stock }}">
                                @error('stock')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
