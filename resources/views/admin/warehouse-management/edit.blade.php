    ...
    <div id="main-wrapper">
        <div class="pageheader pd-t-25 pd-b-35">
            <div class="pd-t-5 pd-b-5">
                <h1 class="pd-0 mg-0 tx-20 text-overflow">Edit Data Manajemen Gudang</h1>
            </div>
                ...
                <div class="card mg-b-20">
                    ...
                    <div class="card-body collapse show" id="collapse1">
                        <form class="form-layout form-layout-1" method="POST"
                            action="{{ route('admin.manajemen-gudang.update', $warehouse->id) }}"
                            ...
                            <div class="form-group mg-b-10-force">
                                ...
                                <input
                                    class="form-control @error('warehouse_name')
                                            is-invalid
                                        @enderror"
                                    type="text" name="warehouse_name" value="{{ $warehouse->warehouse_name }}">
                            ...
                            <div class="form-group mg-b-10-force">
                                ...
                                <input
                                    class="form-control @error('name')
                                            is-invalid
                                        @enderror"
                                    type="text" name="name" value="{{ $warehouse->name }}">
                            ...
                            <div class="form-group mg-b-10-force">
                                ...
                                <input
                                    class="form-control @error('phone')
                                            is-invalid
                                        @enderror"
                                    type="text" name="phone" value="{{ $warehouse->phone }}">
                            ...
                            <div class="form-group mg-b-10-force">
                                ...
                                <textarea
                                    class="form-control @error('address')
                                            is-invalid
                                        @enderror"
                                    type="text" name="address">{{ $warehouse->address }}</textarea>
                            ...
                            <div class="form-group mg-b-10-force">
                                ...
                                <input
                                    class="form-control @error('email')
                                            is-invalid
                                        @enderror"
                                    type="email" name="email" value="{{ $warehouse->email }}" disabled>
                            ...
                            <div class="form-group mg-b-10-force">
                                <label for="">Password Baru (Jika Ingin Diubah)</label><br class="mg-b-10-force">
                                <input
