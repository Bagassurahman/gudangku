    ...
    <div id="main-wrapper">
        <div class="pageheader pd-t-25 pd-b-35">
            <div class="pd-t-5 pd-b-5">
                <h1 class="pd-0 mg-0 tx-20 text-overflow">Input Data Bahan</h1>
            </div>
                ...
                <div class="card mg-b-20">
                    ...
                    <div class="card-body collapse show" id="collapse1">
                        <form class="form-layout form-layout-1" method="POST"
                            action="{{ route('admin.data-bahan.store') }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group mg-b-10-force">
                                ...
                                <input
                                    class="form-control @error('selling_price')
                                            is-invalid
                                        @enderror"
                                    type="text" name="selling_price" value="{{ old('selling_price') }}">
                                @error('selling_price')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-group mg-b-10-force">
                                ...
                                <select name="category" class="form-control">
                                    ...
                                    <option value="Non-Produk">Non-Produk</option>
                                </select>
                            </div>
                            <!-- row -->
