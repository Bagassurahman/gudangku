    ...
    <div class="collapse" id="collapseExample">
        <div class="card card-body">
            <form action="{{ route('outlet.transaction.store') }}" method="POST" id="cart-form">
                ...
                <button class="btn btn-danger mt-3 w-100 btn-submit" type="submit" id="btn-submit">Beli</button>

            </form>
        </div>
    </div>

    <button role="button" class="btn btn-primary btn-cart-mobile" data-toggle="collapse" href="#collapseExample"
            ...
            <div class="col-6 mb-5">
                <div class="card-product">
                    ...
                    <div class="card-body">
                        ...
                        <p style="font-weight: 900">Rp <span class="harga-produk"
                        ...
                        <button class="add-to-cart btn btn-primary w-100" data-id="{{ $product->id }}"
