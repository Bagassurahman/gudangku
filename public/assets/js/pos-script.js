...
$('.add-to-cart').click(function (event) {
    ...
    // Mendapatkan nilai id, name, dan price dari atribut data pada elemen yang diklik
    var id = $(this).data('id');
    var name = $(this).data('name');
    var price = Number($(this).data('price'));

    // Mengirim permintaan AJAX untuk mendapatkan detail produk
    $.get('outlet/detail-produk', {
        id: id
        ...
        if (allMaterialsAvailable) {
            // Menambahkan item ke keranjang dan mengurangi stok produk dengan bahan
